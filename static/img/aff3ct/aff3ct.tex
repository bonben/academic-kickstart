...
\begin{axis}[ybar,
    ...
    % ThunderX2 CN9975
    \addplot[Paired-5,fill=Paired-5!40,draw=Paired-5,
    ...
    % Xeon Phi 7230
    \addplot[Paired-11,fill=Paired-11!40,draw=Paired-11,
    ...
    % Xeon E5-2680 v3
    \addplot[Paired-9,fill=Paired-9!40,draw=Paired-9,
             postaction={pattern color = black!50!Paired-9!70,
                         pattern=grid}
            ]
    ...
    % Xeon Gold 6140
    \addplot[Paired-1,fill=Paired-1!40,draw=Paired-1,
    ...
    % Xeon Gold 6142
    \addplot[black!25!Paired-1!80,fill=Paired-1!20,draw=Paired-1!80,
    ...
    \legend{\color{Paired-5}$2 \times$ThunderX2 CN9975,
            \color{Paired-11}$1 \times$Xeon Phi 7230,
            % $1 \times$Ryzen 7 2700X,
            \color{Paired-9}$2 \times$Xeon E5-2680 v3,
            \color{Paired-1}$2 \times$Xeon Gold 6140,
            \color{Paired-1}$2 \times$Xeon Gold 6142,}
\end{axis}
\end{tikzpicture}
\end{document}
